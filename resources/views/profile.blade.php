                    ...
                    <div class="col-lg-10 col-sm-9">
                        <div class="timeline-info">
                            <ul>
                                ...
                                <li>
                                    <a class="active" href="{{route('profile',encrypt($User->id))}}" title="" data-ripple="">time line</a>
                                    <a class="" href="{{route('profilephotos',encrypt($User->id))}}" title="" data-ripple="">Photos</a>
...
{{--                                    @dd($check)--}}
                                    ...
                                    <div class="central-meta item">
                                        <div class="new-postbox">
                                            <figure>
                                                <img src="{{Storage::url("public/".$User->avatar)}}" alt="">
                                            </figure>
                                                ...
                                                <form id="createForm" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="attachments">
                                                        <ul>
                                                            ...
                                                            {{--                                                        </li>--}}
                                                            <li>
                                                                <button id="postbutton" type="submit">Publish</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="central-meta item">
                                            <div class="user-post">
                                                ...
                                                <div class="friend-info">
                                                    ...
                                                    {{--                                            @dd((new App\Models\User)->getuserdp($posts[$i]->user_id))--}}
                                                    <figure>
                                                        <img src="{{Storage::url("public/".(new App\Models\User)->getuserdp($posts[$i]->user_id))}}" alt="">
                                                    </figure>
                                                    <div class="friend-name">
                                                        <ins><a href="#" title="">{{(new App\Models\User)->getusers($posts[$i]->user_id)}}</a></ins>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="social-media">
                                                                    <div class="menu">
                                                                        ...
                                                                        {{--                                                                </div>--}}
                                                                        <div class="rotater">
                                                                            <div class="btn btn-icon"><a a href="https://www.facebook.com/sharer/sharer.php?u={{ route('single_post',$posts[$i]->id) }}"
                                                                                                         target="_blank"
                                                                                                         title=""><i
