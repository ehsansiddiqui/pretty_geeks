                        ...
                        <div class="timeline-info">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a class="active" href="{{route('profileabout',encrypt($User->id))}}" title="" data-ripple="">about</a>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="basic" >
                                                    <ul class="basics">
                                                        ...
                                                        <li><i class="ti-mobile"></i>{{$User->mobile_number}}</li>
                                                ...
                                                <div class="tab-pane fade" id="work" role="tabpanel">
                                                    <div>
                                                        ...
                                                        <a href="#" title="">{{$User->company_name}}</a>
                                                        <p>work as {{$User->profession}} in {{\Illuminate\Support\Facades\Auth::user()->company_name}} from {{date('Y', strtotime(\Illuminate\Support\Facades\Auth::user()->profession_start_date))}}</p>
                                                        <ul class="education">
                                                            <li><i class="ti-facebook"></i> {{$User->education}} from {{\Illuminate\Support\Facades\Auth::user()->university_name}}</li>
